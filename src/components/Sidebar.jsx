...
const Frame = () => {
  ...
  return (
    <div className="flex flex-col w-[210px] lg:w-[280px] py-5 sm:h-[800px] mt-10 px-4 items-center justify-start gap-[9px] relative bg-lightSideBarBg dark:bg-darkSideBarBg ">
      <div
